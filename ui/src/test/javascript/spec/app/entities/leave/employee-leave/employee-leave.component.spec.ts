...
import { EmployeeLeaveComponent } from 'app/entities/leave/employee-leave/employee-leave.component';
...
describe('Component Tests', () => {
  describe('EmployeeLeave Management Component', () => {
    let comp: EmployeeLeaveComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EmployeeLeaveComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.employeeLeaves[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });

...
import { MeetingRoomComponent } from 'app/entities/meeting/meeting-room/meeting-room.component';
...
describe('Component Tests', () => {
  describe('MeetingRoom Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.meetingRooms[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
